...
public class OVRLipSyncDemo : ModuleRules
{
	public OVRLipSyncDemo(ReadOnlyTargetRules Target) : base(Target)
	{
		...
		PublicDependencyModuleNames.AddRange(new string[] { "AndroidPermission", "Core", "CoreUObject", "Engine", "InputCore", "Voice", "AudioMixer" });

		PrivateDependencyModuleNames.AddRange(new string[] { "Odin", "OVRLipSync" });
	}
}
